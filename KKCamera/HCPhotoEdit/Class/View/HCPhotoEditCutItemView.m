...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSArray *titles = @[@"FREEDOM",@"INSTAGRAM",@"2:3",@"3:4",@"9:16",@"GOLDEN"];
        HCPhotoEditBaseScrollView *scrollView = [[HCPhotoEditBaseScrollView alloc] initWithFrame:self.bounds bottomTitle:@"" imagesNameArray:images titlesArray:titles buttonWidth:self.bounds.size.width/3.0 imageSize:35];
...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view
{
    ...
    HCPhotoEditCutItemView *effectView = [[HCPhotoEditCutItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 140 - offset, view.bounds.size.width, 140 + offset)];
