...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view icons:(NSArray *)icons
{
    ...
    HCPhotoEditSpecialEffectsItemView *effectView = [[HCPhotoEditSpecialEffectsItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset) icons:icons];
