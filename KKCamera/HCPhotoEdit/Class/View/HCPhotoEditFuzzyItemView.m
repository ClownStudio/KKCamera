...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSArray *images = @[@"close",@"circle"];
        HCPhotoEditBaseScrollView *scrollView = [[HCPhotoEditBaseScrollView alloc] initWithFrame:self.bounds bottomTitle:@"" imagesNameArray:images titlesArray:nil buttonWidth:self.bounds.size.width/2.0 imageSize:30];
...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view
{
    ...
    HCPhotoEditFuzzyItemView *effectView = [[HCPhotoEditFuzzyItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset)];
...
-(UIView*)sliderConfigView:(NSInteger)type
{
    ...
    [slider setItemTitles:@[@"1",@"2",@"3",@"4",@"5",@"6"]];
