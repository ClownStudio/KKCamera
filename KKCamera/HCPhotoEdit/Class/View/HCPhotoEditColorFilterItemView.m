...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view icons:(NSArray *)icons
{
    ...
    HCPhotoEditColorFilterItemView *effectView = [[HCPhotoEditColorFilterItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset) icons:icons];
...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view
{
    ...
    HCPhotoEditColorFilterItemView *effectView = [[HCPhotoEditColorFilterItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset)];
    effectView.transform = CGAffineTransformMakeTranslation(0, 150);
    [view addSubview:effectView];
    [UIView animateWithDuration:0.25 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        effectView.transform = CGAffineTransformIdentity;
