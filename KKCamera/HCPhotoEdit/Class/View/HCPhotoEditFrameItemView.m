...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        HCPhotoEditBaseScrollView *scrollView = [[HCPhotoEditBaseScrollView alloc] initWithFrame:self.bounds bottomTitle:@"" imagesNameArray:images titlesArray:nil buttonWidth:100 imageSize:65];
...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view
{
    ...
    HCPhotoEditFrameItemView *effectView = [[HCPhotoEditFrameItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset)];
