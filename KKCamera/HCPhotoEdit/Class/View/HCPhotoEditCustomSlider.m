...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setThumbImage:[UIImage imageNamed:@"FT_EditSliderThumb"] forState:UIControlStateHighlighted];
        [self setThumbImage:[UIImage imageNamed:@"FT_EditSliderThumb"] forState:UIControlStateNormal];
