...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        HCPhotoEditBaseScrollView *scrollView = [[HCPhotoEditBaseScrollView alloc] initWithFrame:self.bounds bottomTitle:@"" imagesNameArray:images titlesArray:titles buttonWidth:90 imageSize:55];
...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view
{
    ...
    HCPhotoEditLightItemView *effectView = [[HCPhotoEditLightItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset)];
