...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSArray *titles = @[@"LEVEL",@"SHARPNESS",@"COLOR",@"EXPOSURE",@"CONTRAST",@"SATURATION",@"BRIGHTNESS",@"SHADOW",@"VIGNETTE"];
        HCPhotoEditBaseScrollView *scrollView = [[HCPhotoEditBaseScrollView alloc] initWithFrame:self.bounds bottomTitle:@"" imagesNameArray:images titlesArray:titles buttonWidth:90 imageSize:20];
...
+(HCPhotoEditBaseItemView*)showInView:(UIView*)view
{
    ...
    HCPhotoEditAdjustItemView *effectView = [[HCPhotoEditAdjustItemView alloc] initWithFrame:CGRectMake(0, view.bounds.size.height - 150 - offset, view.bounds.size.width, 150 + offset)];
...
-(void)sliderValueChanged:(UISlider*)slider
{
    switch (configView.tag) {
            ...
            //层次
        {
            ...
            [self updateTitle:@"LEVEL" value:slider.value];
        }
            ...
            //清晰度
        {
            ...
            [self updateTitle:@"SHARPNESS" value:slider.value];
        }
            ...
            //色温
        {
            ...
            [self updateTitle:@"COLOR" value:slider.value];
        }
            ...
            //曝光度
        {
            ...
            [self updateTitle:@"EXPOSURE" value:slider.value];
        }
            break;
        case 4:
            //对比度
        {
            ...
            [self updateTitle:@"CONTRAST" value:slider.value];
        }
            break;
        case 5:
            //饱和度
        {
            ...
            [self updateTitle:@"SATURATION" value:slider.value];
        }
            break;
        case 6:
            //高光
        {
            ...
            [self updateTitle:@"BRIGHTNESS" value:slider.value];
        }
            ...
            //阴影
        {
            ...
            [self updateTitle:@"SHADOW" value:slider.value];
        }
            break;
        case 8:
            //暗角
        {
            ...
            [self updateTitle:@"VIGNETTE" value:slider.value];
        }
            break;
