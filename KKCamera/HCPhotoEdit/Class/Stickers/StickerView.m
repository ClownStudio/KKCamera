...
- (id)initWithImage:(UIImage *)image
{
    ...
    if(self)
    {
        ...
        [_deleteButton setImage:[UIImage imageNamed:@"sticker_delete.png"] forState:UIControlStateNormal];
...
- (void)pushedDeleteBtn:(id)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(willDeleteStickerView:)]) {
        [self.delegate willDeleteStickerView:self];
    }
